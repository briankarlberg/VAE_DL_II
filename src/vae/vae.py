...
class DRT_VAE:
    @staticmethod
    def build_small_model(train_data: np.ndarray, validation_data: np.ndarray, input_dimension: int,
    ...
    @staticmethod
    def build_big_model(train_data: np.ndarray, validation_data: np.ndarray, input_dimension: int,
                        embedding_dimension: int, activation='relu'):
        """
        Model is being used for files containing all feature. e.g. 40k features
        """
        r = regularizers.l1_l2(10e-5)
